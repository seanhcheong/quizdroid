...
//
//
//        Topic physics = new Topic(title, desc, topicOptions);
//        Topic math = new Topic(title, desc, topicOptions);
//        Topic marvel = new Topic(title, desc, topicOptions);
//
//        Quiz physicsQ1 = new Quiz(title, desc, questionAsked, correctAnswer, answerOptions);
//        Quiz physicsQ2 = new Quiz(title, desc, questionAsked, correctAnswer, answerOptions);
//        Quiz physicsQ3 = new Quiz(title, desc, questionAsked, correctAnswer, answerOptions);
//
//        Quiz mathQ1 = new Quiz(title, desc, questionAsked, correctAnswer, answerOptions);
//        Quiz mathQ2 = new Quiz(title, desc, questionAsked, correctAnswer, answerOptions);
//        Quiz mathQ3 = new Quiz(title, desc, questionAsked, correctAnswer, answerOptions);
//
//        Quiz marvelQ1 = new Quiz(title, desc, questionAsked, correctAnswer, answerOptions);
//        Quiz marvelQ2 = new Quiz(title, desc, questionAsked, correctAnswer, answerOptions);
//        Quiz marvelQ3 = new Quiz(title, desc, questionAsked, correctAnswer, answerOptions);
//
